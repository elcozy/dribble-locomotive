...
const footerItems = ["about", "features", "works", "support"];
const Footer: NextPage = () => {
  return (
    <div
      id="resources"
      className="flex flex-col bg-gray-50 justify-center py-6 md:py-7 text-gray-500 items-center"
    >
      <div className="container">
        <footer className="relative md:pb-7">
          <div className="container mx-auto px-6">
            <div className=" sm:grid sm:grid-cols-6 lg:flex mt-4 sm:mt-0 sm:w-full sm:px-8 flex flex-col lg:flex-row gap-4 lg:gap-2 justify-between">
        ...
        <div className="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row items-center justify-center md:justify-between text-gray-400 text-xs text-center md:text-sm gap-2 md:gap-0 border-t pt-6">
